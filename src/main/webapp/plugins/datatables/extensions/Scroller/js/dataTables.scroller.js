...
Scroller.prototype = /** @lends Scroller.prototype */{
	 ...
	 *  @param {int} [virtual=false] Perform the calculations in the virtual entity
	...
	/**
	 * Convert from one entity to another. The physical entity is the actual
	 ...
	 * only to that maximum value and virtual / physical entity transforms will
